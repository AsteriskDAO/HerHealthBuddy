...
export default function TelegramHealthCheck() {
    ...
    const contract = getContract({
        client: client,
        chain: baseSepolia,
        address: "0xaa4623D56Bd35a3BFA62868D1036F097D2cb7277"
    });
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <h1 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '2rem', textAlign: 'center' }}>Daily check-in</h1>
                {!account ? (
                    <ConnectButton
                        client={client}
                        accountAbstraction={{
